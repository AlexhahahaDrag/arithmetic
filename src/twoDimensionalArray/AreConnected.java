...
public class AreConnected {
    ...
    public static void main(String[] args) {
      ...
      /*  26
        ...
        */AreConnected areConnected = new AreConnected();
        System.out.println(areConnected.areConnected(n, threshold, queries));
        System.out.println(areConnected.gcb(21, 35));
    }
}

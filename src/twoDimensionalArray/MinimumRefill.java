...
public class MinimumRefill {
    ...
    public int minimumRefill(int[] plants, int capacityA, int capacityB) {
        ...
        if (left == right && Math.max(leftWater, rightWater) < plants[left]) {
            count++;
        }
        return count;
    }
...
//        int capacityA = 3;
//        int capacityB = 4; // 2
        System.out.println(new MinimumRefill().minimumRefill(plants, capacityA, capacityB));
    }
}

...
public class ThroneInheritance {
    ...
    public ThroneInheritance(String kingName) {
        kingMap = new HashMap<>();
        kingMap.put(kingName, new ArrayList<>());
        king = kingName;
        dead = new HashSet<>();
    }

    public void birth(String parentName, String childName) {
        List<String> child = kingMap.computeIfAbsent(parentName, k -> new ArrayList<>());
        child.add(childName);
    }
    ...
    private void dfs(String name, List<String> res) {
        ...
        List<String> child = kingMap.get(name);

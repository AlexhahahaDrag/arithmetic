...
public class TemperatureTrend {
    ...
    public static void main(String[] args) {
        ...
        int[] arr2 = {34, 32, 16, 16, 17}; // 3
//        int[] arr1 = {21, 18, 20, 18, 31};
//        int[] arr2 = {34, 32, 34, 16, 24}; // 4
        System.out.println(new TemperatureTrend().temperatureTrend(arr1, arr2));
    }
}

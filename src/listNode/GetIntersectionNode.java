...
public class GetIntersectionNode {
    ...
    public static void main(String[] args) {
        ...
        ListNode listA = ListNode.getListNodeByArr(arrA);
        ListNode listB = ListNode.getListNodeByArr(arrB);
        GetIntersectionNode getIntersectionNode = new GetIntersectionNode();
        ListNode res = getIntersectionNode.getIntersectionNode(listA, listB);
